...
class UserController extends AbstractController
{
	public function actionEditProfile()
	{
		...
		$this->render($this->renderData(array('hornav' => $hornav, 'formAvatar' => $formAvatar, 'formName' => $formName, 'formPassword' => $formPassword), 'profile', array('avatar' => $this->authUser->avatar, 'maxSize' =>(Config::MAX_SIZE_AVATAR / KB_B))));
	}
