...
INSERT INTO `xyz_categories` (`id`, `title`, `img`, `sectionId`, `description`, `metaDesc`, `metaKey`) VALUES
...
INSERT INTO `xyz_comments` (`id`, `articleId`, `userId`, `parentId`, `text`, `date`) VALUES
...
INSERT INTO `xyz_poll_data` (`id`, `pollId`, `title`) VALUES
(1, 1, 'HTML'),
(2, 1, 'CSS'),
(3, 1, 'JavaScript'),
(4, 1, 'PHP'),
...
CREATE TABLE IF NOT EXISTS `xyz_poll_voters` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pollDataId` int(10) unsigned NOT NULL,
...
INSERT INTO `xyz_poll_voters` (`id`, `pollDataId`, `ip`, `date`) VALUES
...
INSERT INTO `xyz_users` (`id`, `login`, `email`, `password`, `name`, `avatar`, `dateReg`, `activation`) VALUES
